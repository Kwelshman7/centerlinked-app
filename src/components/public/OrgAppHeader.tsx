  ...
  return (
    <header className="sticky top-0 z-40 bg-card/95 backdrop-blur-xl border-b border-border/60 print:hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between gap-4">
        <Link to={orgHref} className="flex items-center gap-2.5 min-w-0 shrink-0">
          <div
          ...
          <span className="font-heading font-bold text-sm sm:text-base truncate hidden sm:block">
            {org.name}
          </span>
        </Link>
