...
const DESCRIPTION =
  "A nationally recognized, Joint Commission-accredited network of treatment centers offering detox, residential, PHP, IOP, and mental health programs across the country. Partners get one verified link for every location.";
      ...
      <div className="flex-1 min-h-0 overflow-hidden pb-[3.75rem]">
        ...
        <main className="px-3.5 pt-2.5 pb-2 space-y-2.5">
          ...
          <section className="space-y-2">
            ...
            {/* Natural card height — no forced rows that squash thumbnails */}
