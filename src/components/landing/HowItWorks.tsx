  ...
  return (
    <section className="py-20 lg:py-28 bg-background">
      <div className="container">
        ...
        <div className="mt-14 border-t border-border pt-10 max-w-4xl mx-auto">
          <p className="text-center text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-8">Your BD reps use it everywhere</p>
          <div className="grid sm:grid-cols-2 gap-4">
            {moments.map((m) => (
              <div key={m.title} className="flex gap-4 p-5 rounded-xl bg-card border border-border hover:border-primary/30 transition-colors">
