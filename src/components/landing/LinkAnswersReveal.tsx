...
function AnswerCard({
  ...
  return (
    ...
    >
      <article
        className={cn(
          "flex h-full min-h-[5.75rem] flex-col rounded-xl border border-border/50 bg-card",
          "px-3.5 py-3.5 sm:px-4 sm:py-4",
          "shadow-[0_10px_28px_-16px_rgba(15,23,42,0.22)]",
          "transition-[transform,box-shadow] duration-300",
          "hover:-translate-y-0.5 hover:shadow-[0_16px_32px_-16px_rgba(15,23,42,0.28)]",
        )}
      >
...
export function LinkAnswersReveal({
  ...
  return (
    <div ref={ref} className={cn("space-y-6 sm:space-y-7", className)}>
      <ul className="grid grid-cols-1 auto-rows-fr gap-3 sm:grid-cols-2 sm:gap-3">
