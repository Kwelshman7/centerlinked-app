    ...
    <LegalPageLayout title="Terms of Service" effectiveDate={EFFECTIVE_DATE}>
      ...
      <section>
        ...
        <p>
          ...
          only view a public profile. Membership is priced by how many live facilities the organization lists: 1 facility
          is $99 per month, 2–5 facilities is $249 per month, and 6–15 facilities is $499 per month. Annual billing is
          two months free ($990, $2,490, and $4,990 respectively). Organizations with 16 or more facilities are quoted.
          An optional one-time Done For You setup is $499 (1 facility), $1,200 (2–5 facilities), or $2,500 (6–15
          facilities); 16+ setup is quoted. Team seats are unlimited on every paid plan. During early access,
          organizations may continue to use the Service if membership is not yet active; we may change that at any time.
