  ...
  return (
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 -mt-5 lg:-mt-8">
      <section className="relative overflow-hidden bg-hero-gradient">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center px-4 pb-8 pt-4 sm:px-6 sm:pb-14 sm:pt-12 lg:px-8 lg:pb-16 lg:pt-14">
          <div className="animate-fade-up flex w-full flex-col items-center text-center">
            ...
            <h1 className="font-heading text-[1.45rem] font-extrabold leading-[1.15] tracking-tight text-foreground sm:text-4xl sm:leading-[1.1]">
              Find in-network programs
            </h1>
            <p className="mt-1.5 max-w-md text-sm text-muted-foreground sm:mt-3 sm:text-base">
