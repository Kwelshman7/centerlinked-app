  ...
  public: {
    Tables: {
      ...
      organization_account_events: {
        Row: { changed_by: string | null; created_at: string; from_status: Database['public']['Enums']['org_account_status'] | null; id: string; organization_id: string; reason: string | null; to_status: Database['public']['Enums']['org_account_status'] }
        Insert: { changed_by?: string | null; created_at?: string; from_status?: Database['public']['Enums']['org_account_status'] | null; id?: string; organization_id: string; reason?: string | null; to_status: Database['public']['Enums']['org_account_status'] }
        Update: { changed_by?: string | null; created_at?: string; from_status?: Database['public']['Enums']['org_account_status'] | null; id?: string; organization_id?: string; reason?: string | null; to_status?: Database['public']['Enums']['org_account_status'] }
        Relationships: [{ foreignKeyName: 'organization_account_events_organization_id_fkey'; columns: ['organization_id']; isOneToOne: false; referencedRelation: 'organizations'; referencedColumns: ['id'] }]
      }
      organizations: {
        Row: { accent_color: string | null; account_status: Database['public']['Enums']['org_account_status']; account_status_changed_at: string | null; account_status_changed_by: string | null; account_status_reason: string | null; announcement: string | null; bd_contact_email: string | null; bd_contact_name: string | null; bd_contact_phone: string | null; billing_email: string | null; brand_color: string | null; cover_image_url: string | null; footer_image_url: string | null; social_facebook_url: string | null; social_instagram_url: string | null; social_linkedin_url: string | null; social_x_url: string | null; created_at: string; created_by: string | null; cta_primary_label: string | null; cta_secondary_label: string | null; description: string | null; email_domain: string | null; hq_city: string | null; hq_state: string | null; id: string; image_urls: string[]; logo_url: string | null; name: string; num_facilities: number | null; phone: string | null; program_badges: string[]; setup_package: string | null; slug: string | null; stripe_customer_id: string | null; stripe_subscription_id: string | null; subscription_current_period_end: string | null; subscription_price_id: string | null; subscription_status: string; tagline: string | null; updated_at: string; verified: boolean; website: string | null; why_refer: Json }
        Insert: { accent_color?: string | null; account_status?: Database['public']['Enums']['org_account_status']; account_status_changed_at?: string | null; account_status_changed_by?: string | null; account_status_reason?: string | null; announcement?: string | null; bd_contact_email?: string | null; bd_contact_name?: string | null; bd_contact_phone?: string | null; billing_email?: string | null; brand_color?: string | null; cover_image_url?: string | null; footer_image_url?: string | null; social_facebook_url?: string | null; social_instagram_url?: string | null; social_linkedin_url?: string | null; social_x_url?: string | null; created_at?: string; created_by?: string | null; cta_primary_label?: string | null; cta_secondary_label?: string | null; description?: string | null; email_domain?: string | null; hq_city?: string | null; hq_state?: string | null; id?: string; image_urls?: string[]; logo_url?: string | null; name: string; num_facilities?: number | null; phone?: string | null; program_badges?: string[]; setup_package?: string | null; slug?: string | null; stripe_customer_id?: string | null; stripe_subscription_id?: string | null; subscription_current_period_end?: string | null; subscription_price_id?: string | null; subscription_status?: string; tagline?: string | null; updated_at?: string; verified?: boolean; website?: string | null; why_refer?: Json }
        Update: { accent_color?: string | null; account_status?: Database['public']['Enums']['org_account_status']; account_status_changed_at?: string | null; account_status_changed_by?: string | null; account_status_reason?: string | null; announcement?: string | null; bd_contact_email?: string | null; bd_contact_name?: string | null; bd_contact_phone?: string | null; billing_email?: string | null; brand_color?: string | null; cover_image_url?: string | null; footer_image_url?: string | null; social_facebook_url?: string | null; social_instagram_url?: string | null; social_linkedin_url?: string | null; social_x_url?: string | null; created_at?: string; created_by?: string | null; cta_primary_label?: string | null; cta_secondary_label?: string | null; description?: string | null; email_domain?: string | null; hq_city?: string | null; hq_state?: string | null; id?: string; image_urls?: string[]; logo_url?: string | null; name?: string; num_facilities?: number | null; phone?: string | null; program_badges?: string[]; setup_package?: string | null; slug?: string | null; stripe_customer_id?: string | null; stripe_subscription_id?: string | null; subscription_current_period_end?: string | null; subscription_price_id?: string | null; subscription_status?: string; tagline?: string | null; updated_at?: string; verified?: boolean; website?: string | null; why_refer?: Json }
        Relationships: []
      }
      payers: {
    ...
    Functions: {
      ...
      admin_set_organization_account_status: { Args: { _org_id: string; _status: Database['public']['Enums']['org_account_status']; _reason?: string | null }; Returns: boolean }
      org_account_status_of: { Args: { _org_id: string }; Returns: Database['public']['Enums']['org_account_status'] }
      org_allows_member_writes: { Args: { _org_id: string }; Returns: boolean }
      org_is_publicly_visible: { Args: { _org_id: string }; Returns: boolean }
    ...
    Enums: {
      ...
      org_account_status: 'active' | 'suspended' | 'archived'
