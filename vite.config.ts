...
export default defineConfig(({ mode }) => {
  ...
  process.env.STRIPE_PRICE_PROFILE_YEAR = env.STRIPE_PRICE_PROFILE_YEAR;
  process.env.STRIPE_PRICE_NETWORK = env.STRIPE_PRICE_NETWORK;
  process.env.STRIPE_PRICE_NETWORK_YEAR = env.STRIPE_PRICE_NETWORK_YEAR;
  process.env.STRIPE_PRICE_GROUP = env.STRIPE_PRICE_GROUP;
  process.env.STRIPE_PRICE_GROUP_YEAR = env.STRIPE_PRICE_GROUP_YEAR;
  process.env.STRIPE_PRICE_SETUP = env.STRIPE_PRICE_SETUP;
  process.env.STRIPE_PRICE_SETUP_NETWORK = env.STRIPE_PRICE_SETUP_NETWORK;
